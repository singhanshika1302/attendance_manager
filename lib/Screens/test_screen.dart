...
//   // Filter attendance data based on the subject name
//   if (attendanceDataList != null) {
//     subjectAttendanceData = attendanceDataList
//         .where((data) => data.subject == subjectName)
//         .map((data) => data.toJson())
//         .toList();
//   }

//   // Process filtered attendance data for month-wise attendance
...
//     _totalClasses = totalClasses;
//     _totalPresentClasses = totalPresentClasses;
//     // Assuming you want to update your bar group data here
//     showingBarGroups = _generateBarGroups(monthWiseAttendance);
//   });
// }
